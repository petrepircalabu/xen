                       ...
                       libxl_domain_config *d_config)
{
    ...
    if (!xlu_cfg_get_long(config, "paging_ring_order", &l, 1)) {
        b_info->vm_event_params.paging_ring_order = l;
    }

    if (!xlu_cfg_get_long(config, "monitor_ring_order", &l, 1)) {
        b_info->vm_event_params.monitor_ring_order = l;
    }

    if (!xlu_cfg_get_long(config, "sharing_ring_order", &l, 1)) {
        b_info->vm_event_params.sharing_ring_order = l;
    }
